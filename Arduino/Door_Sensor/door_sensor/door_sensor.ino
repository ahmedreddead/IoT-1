...
const char* mqtt_server = "10.20.0.31";

char* msgTopic = "Micropolis/door_sensor/";
char* msgTopic2 = "Micropolis/door_sensor";

const char* sensor_id = "do55411";


String open_message = String("{id:" + String(sensor_id) + ",status:opened}");
String closed_message = String("{id:" + String(sensor_id) + ",status:closed}");

const char* str_open = open_message.c_str();
const char* str_close = closed_message.c_str();
    ...
    if (last_state != "open")
{
    ...
    client.publish(msgTopic2, str_open);
    last_state = "open"; 
}
    ...
    if (last_state != "close")
{
    ...
    client.publish(msgTopic2, str_close);
    last_state = "close"; 
