...
#define ADC_SERVER_URL "http://10.20.0.175:8000/adc_samples"
#define I2S_SERVER_URL "http://10.20.0.175:8000/i2s_samples"

WiFiUDP Udp;
const char* udpAddress = "10.20.0.175";
...
void setup()
{
  ...
  xTaskCreatePinnedToCore(i2sMemsWriterTask, "I2S Writer Task",  4096, i2sSampler, 1, &i2sMemsWriterTaskHandle, 1); // 4096*8
